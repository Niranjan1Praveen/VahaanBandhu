...
**VahaanBandhu · the routing research · dataset `v0.1`**
...
The the quantity rule *"never fabricate the latitude/longitude of an actual mandi"* is
...
- **Status:** **Not acquired.** the routing research proceeds on synthetic data by explicit project
...
**Critical note for the application:** e-NAM covers *integrated* markets only. It is **not** the
...
**the application must** populate state / district / subdistrict / village codes from LGD, and
...
Because of that uncertainty, the routing research deliberately does **not** persist any TomTom
...
- **Status:** Integration ready and **verified connected** during the routing research.
...
| `coordinate_verified` | Mandi-specific; `False` throughout the routing research |
