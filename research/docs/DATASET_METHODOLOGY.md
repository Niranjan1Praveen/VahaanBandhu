...
The the quantity rule *"never fabricate the latitude/longitude of an actual mandi"* is honoured
...
Stage sizes are configurable (`prototype` / `pilot` / `training`). the routing research deliberately
