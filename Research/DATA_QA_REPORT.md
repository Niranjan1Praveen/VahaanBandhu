...
The Phase-A brief suggested a coarse rejection box of 23.0–31.5 N. **That upper
...
> No boundary polygons available in Phase-A. A point just across a real district border will not be detected. Phase-B must use LGD polygons.
...
1. **Containment uses circular district envelopes, not boundary polygons.** A point
   just across a real district border will not be detected. Phase-B must use LGD
   polygons.
